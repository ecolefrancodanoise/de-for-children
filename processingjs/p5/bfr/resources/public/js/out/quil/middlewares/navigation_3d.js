...
var vec__41430 = axis;
var a_x = cljs.core.nth.call(null,vec__41430,(0),null);
var a_y = cljs.core.nth.call(null,vec__41430,(1),null);
var a_z = cljs.core.nth.call(null,vec__41430,(2),null);
var vec__41433 = v;
var x = cljs.core.nth.call(null,vec__41433,(0),null);
var y = cljs.core.nth.call(null,vec__41433,(1),null);
var z = cljs.core.nth.call(null,vec__41433,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__41436,p__41437){
var vec__41444 = p__41436;
var u1 = cljs.core.nth.call(null,vec__41444,(0),null);
var u2 = cljs.core.nth.call(null,vec__41444,(1),null);
var u3 = cljs.core.nth.call(null,vec__41444,(2),null);
var vec__41447 = p__41437;
var v1 = cljs.core.nth.call(null,vec__41447,(0),null);
var v2 = cljs.core.nth.call(null,vec__41447,(1),null);
var v3 = cljs.core.nth.call(null,vec__41447,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__41450_SHARP_){
return (p1__41450_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__41451_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__41452_SHARP_,angle_lr),angle_ud);
...
var map__41459 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__41459__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__41459__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__41461 = cljs.core._EQ_;
var expr__41462 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__41461.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__41462))){
return straight;
} else {
if(cljs.core.truth_(pred__41461.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__41462))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__41461.call(null,quil.middlewares.navigation_3d.space,expr__41462))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__41461.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__41462))){
return up;
} else {
if(cljs.core.truth_(pred__41461.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__41462))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__41461.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__41462))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__41459,map__41459__$1,up,straight){
return (function (p1__41453_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__41453_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__41459,map__41459__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__41464_SHARP_);
});})(initial_state))
);
});
/**
...
var map__41476_41487 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__41476_41488__$1 = ((((!((map__41476_41487 == null)))?((((map__41476_41487.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41476_41487.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__41476_41487):map__41476_41487);
var vec__41477_41489 = cljs.core.get.call(null,map__41476_41488__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_41490 = cljs.core.nth.call(null,vec__41477_41489,(0),null);
var c_y_41491 = cljs.core.nth.call(null,vec__41477_41489,(1),null);
var c_z_41492 = cljs.core.nth.call(null,vec__41477_41489,(2),null);
var vec__41480_41493 = cljs.core.get.call(null,map__41476_41488__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_41494 = cljs.core.nth.call(null,vec__41480_41493,(0),null);
var u_y_41495 = cljs.core.nth.call(null,vec__41480_41493,(1),null);
var u_z_41496 = cljs.core.nth.call(null,vec__41480_41493,(2),null);
var vec__41483_41497 = cljs.core.get.call(null,map__41476_41488__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_41498 = cljs.core.nth.call(null,vec__41483_41497,(0),null);
var p_y_41499 = cljs.core.nth.call(null,vec__41483_41497,(1),null);
var p_z_41500 = cljs.core.nth.call(null,vec__41483_41497,(2),null);
quil.core.camera.call(null,p_x_41498,p_y_41499,p_z_41500,(p_x_41498 + c_x_41490),(p_y_41499 + c_y_41491),(p_z_41500 + c_z_41492),u_x_41494,u_y_41495,u_z_41496);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1513020384608