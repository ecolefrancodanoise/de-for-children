...
var reader = (function (){var or__34564__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__34564__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__34564__auto__)){
return or__34564__auto__;
} else {
return (128);
...
var line = cljs.core.get.call(null,map__39295__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__39295__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.sanity_hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e39294){var _e = e39294;
return false;
}});
devtools.sanity_hints.type_error_to_string = (function devtools$sanity_hints$type_error_to_string(self){
var temp__4655__auto___39297 = devtools.sanity_hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___39297)){
var seen_errors_39298 = temp__4655__auto___39297;
if(cljs.core.truth_(seen_errors_39298.has(self))){
} else {
seen_errors_39298.add(self);

var temp__4657__auto___39299 = devtools.sanity_hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___39299)){
var sense_39300 = temp__4657__auto___39299;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),cljs.core.str.cljs$core$IFn$_invoke$arity$1(", a sanity hint:\n"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_39300)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=sanity_hints.js.map?rel=1513021397181